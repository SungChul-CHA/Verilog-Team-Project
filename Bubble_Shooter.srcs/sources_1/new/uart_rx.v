`timescale 1ns / 1ps
//////////////////////////////////////////////////////////////////////////////////
// uart_rx #(BAUD_RATE, DATA_BIT, PARITY_BIT, STOP_BIT) uart_rx_inst (clk, rstn, uart_rxd, rx_busy, uart_VD, uart_rx_data);
...
// 11/28 CHA
// clk : must 100MHz
// uart_rxd : input uart data
// uart_rx_data : output uart_data (8bits)
// others : NOT USE
//
//////////////////////////////////////////////////////////////////////////////////
